 ...
 */
class Version20161028133353 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE number CHANGE complete_tc complete_tc INT DEFAULT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE number CHANGE complete_tc complete_tc TINYINT(1) DEFAULT NULL');
    }
}
