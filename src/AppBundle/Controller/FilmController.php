...
class FilmController extends Controller
{
     ...
     *
     * @Route("/new", name="editeur_film_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('editeur_film_show', array('id' => $film->getId()));
        }
     ...
     *
     * @Route("/{id}", name="editeur_film_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="editeur_film_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Film $film)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('editeur_film_edit', array('id' => $film->getId()));
        }
     ...
     *
     * @Route("/{id}", name="editeur_film_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Film $film)
    {
        ...
        return $this->redirectToRoute('editeur_film_index');
    }
    ...
    private function createDeleteForm(Film $film)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('editeur_film_delete', array('id' => $film->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
