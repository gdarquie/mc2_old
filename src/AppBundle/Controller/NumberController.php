...
class NumberController extends Controller
{
     ...
     *
     * @Route("/", name="editeur_number_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="editeur_number_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('editeur_number_show', array('id' => $number->getId()));
        }
     ...
     *
     * @Route("/{id}", name="editeur_number_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="editeur_number_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Number $number)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('editeur_number_edit', array('id' => $number->getId()));
        }
     ...
     *
     * @Route("/{id}", name="editeur_number_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Number $number)
    {
        ...
        return $this->redirectToRoute('editeur_number_index');
    }
    ...
    private function createDeleteForm(Number $number)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('editeur_number_delete', array('id' => $number->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
