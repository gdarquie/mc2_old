...
class Film
{
     ...
     * @var integer
     *
     * @ORM\Column(name="number_medley", type="integer", nullable=true)
     */
    private $numberMedley;

    /**
     * @var integer
     *
     * @ORM\Column(name="number_completeness_idcompleteness", type="integer", nullable=true)
     */
    private $numberCompletenessIdcompleteness;

    /**
     * @var integer
     *
     * @ORM\Column(name="number_ensemble_music", type="integer", nullable=true)
     */
    private $numberEnsembleMusic;

    /**
     * @var integer
     *
     * @ORM\Column(name="number_ensemble_dance", type="integer", nullable=true)
     */
    private $numberEnsembleDance;
     ...
     * Set numberMedley
     *
     * @param integer $numberMedley
     *
     * @return Film
     */
    public function setNumberMedley($numberMedley)
    {
        $this->numberMedley = $numberMedley;
     ...
     * @return integer
     */
    public function getNumberMedley()
    {
        return $this->numberMedley;
    }

    /**
     * Set numberCompletenessIdcompleteness
     *
     * @param integer $numberCompletenessIdcompleteness
     *
     * @return Film
     */
    public function setNumberCompletenessIdcompleteness($numberCompletenessIdcompleteness)
    {
        $this->numberCompletenessIdcompleteness = $numberCompletenessIdcompleteness;

        return $this;
    }

    /**
     * Get numberCompletenessIdcompleteness
     *
     * @return integer
     */
    public function getNumberCompletenessIdcompleteness()
    {
        return $this->numberCompletenessIdcompleteness;
    }

    /**
     * Set numberEnsembleMusic
     *
     * @param integer $numberEnsembleMusic
     *
     * @return Film
     */
    public function setNumberEnsembleMusic($numberEnsembleMusic)
    {
        $this->numberEnsembleMusic = $numberEnsembleMusic;

        return $this;
    }

    /**
     * Get numberEnsembleMusic
     *
     * @return integer
     */
    public function getNumberEnsembleMusic()
    {
        return $this->numberEnsembleMusic;
    }

    /**
     * Set numberEnsembleDance
     *
     * @param integer $numberEnsembleDance
     *
     * @return Film
     */
    public function setNumberEnsembleDance($numberEnsembleDance)
    {
        $this->numberEnsembleDance = $numberEnsembleDance;

        return $this;
    }

    /**
     * Get numberEnsembleDance
     *
     * @return integer
     */
    public function getNumberEnsembleDance()
    {
        return $this->numberEnsembleDance;
    }
