...
var news = '<h3>Patch V0.2.8 | List of modifications</h3><li>Results for "search a movie" are just under the input field (bug corrected)</li><li>Graph "Number of filsms by year" : number of numbers added</li>';
